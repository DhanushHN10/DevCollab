      ...
      <div className='flex items-center justify-center h-full  px-4 z-10 absolute mt-10  flex-col text-center space-y-6 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
        <div className='w-full max-w-md bg-white/10 backdrop-blur-md border border-white/40 shadow-4xl rounded-2xl p-8 text-white z-10'>
          ...
          <div className='space-y-4 '>
            ...
            <Input
              className='text-white transition-transform duration-200 hover:scale-105 hover:font-semibold'
              type='email'
              placeholder='Email'
              value={email}
          ...
          <Button
            className='mt-6 w-full bg-white/20 hover:bg-white/70 hover:text-black border border-white text-white transition-transform duration-200 hover:scale-105'
            onClick={handleLogin}
          >
            Sign In
          </Button>
